...
function Page() {
  ...
  return (
    ...
    <h2 className="section-title px-5 text-center"><span className="px-2 text-center">Trandy Products</span></h2>
        ...
        >
                <div className="card product-item border-0 mb-4">
                    ...
                    <div className="card-footer d-flex justify-content-between bg-light border">
                        ...
                        <a onClick={() => addItem(item)} className="btn btn-sm text-dark p-0"><i className="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                    </div>
                </div>
            </Col>
