  ...
  render() {
    ...
    <div className="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div className="row px-xl-5 pt-5">
         ...
         <p className="mb-0"><i className="fa fa-phone-alt text-primary mr-3"></i>+01096550704</p>
            </div>
                ...
                <div className="row">
                    <div className="col-md-4 mb-5">
                        ...
                        <div className="d-flex flex-column justify-content-start">
                            ...
                            <Link className="text-dark mb-2" to="/Detail"><i className="fa fa-angle-right mr-2"></i>Shop Detail</Link>
